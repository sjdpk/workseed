...
import { ChevronRight, WorkseedsMark } from "./icons";
...
export function Header() {
  ...
  return (
    <header>
      <div className="nav">
        <a className="logo" href="#top" aria-label="Workseeds home">
          <WorkseedsMark />
          Workseeds
        </a>
        ...
        <div className="nav-right">
          ...
          <ThemeToggle />
          <Link className="btn ghost signin" href="/login">
            Sign in
          </Link>
          <a className="btn pri demo-nav" href="#contact">
            Get a demo
          </a>
          <button
            ref={burgerRef}
      ...
      >
        <div className="drawer-in" ref={innerRef}>
          {[...NAV, { href: "#faq", label: "FAQ" }].map((l) => (
            <a key={l.href} className="dl" href={l.href} onClick={() => setMenuOpen(false)}>
              {l.label}
              <ChevronRight />
            </a>
          ))}
          <div className="two-up">
            <Link className="btn" href="/login" onClick={() => setMenuOpen(false)}>
              Sign in
            </Link>
            <a className="btn pri" href="#contact" onClick={() => setMenuOpen(false)}>
              Get a demo
            </a>
          </div>
        </div>
