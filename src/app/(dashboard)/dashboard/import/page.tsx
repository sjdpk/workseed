              ...
              <div className="max-h-60 overflow-y-auto rounded border border-red-200 dark:border-red-800">
                <table className="min-w-full divide-y divide-red-200 dark:divide-red-800">
                  <thead className="bg-red-50 dark:bg-red-900/20">
                    <tr>
                      <th className="px-4 py-2 text-left text-xs font-medium text-red-600 dark:text-red-400">
                        Row
                      </th>
                      <th className="px-4 py-2 text-left text-xs font-medium text-red-600 dark:text-red-400">
                        Identifier
        ...
        <div className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
          {importType === "users" && (
            <>
              ...
              <p>
                <strong>Optional columns:</strong> password (default: Welcome@123), employeeId
                (auto-generated if empty), phone, role (ADMIN/HR/MANAGER/TEAM_LEAD/EMPLOYEE), status
                (ACTIVE/INACTIVE/SUSPENDED), designation, employmentType
                (FULL_TIME/PART_TIME/CONTRACT/INTERN), joiningDate, departmentCode, teamCode,
                branchCode
              </p>
              <p>
                <strong>Note:</strong> Department, team, and branch can be specified by code or
                name.
              </p>
            </>
          )}
          {importType === "leave-allocations" && (
            <>
              <p>
                <strong>Required columns:</strong> employeeId, leaveTypeCode, allocated
              </p>
              <p>
                <strong>Optional columns:</strong> year (default: current year), carriedOver,
                adjusted, notes
              </p>
              <p>
                <strong>Note:</strong> Leave type can be specified by code or name. If allocation
          ...
          {importType === "departments" && (
            <>
              ...
              <p>
                <strong>Optional columns:</strong> description, branchCode, headEmployeeId, isActive
              </p>
            </>
          )}
          {importType === "teams" && (
            <>
              <p>
                <strong>Required columns:</strong> code, name, departmentCode
              </p>
              <p>
                <strong>Optional columns:</strong> description, leadEmployeeId, isActive
              </p>
            </>
          )}
          {importType === "branches" && (
            <>
              ...
              <p>
                <strong>Optional columns:</strong> address, city, state, country, phone, email,
                isActive
              </p>
            </>
          )}
