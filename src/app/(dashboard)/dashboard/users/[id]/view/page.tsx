      ...
      {(user.linkedIn || user.twitter || user.github || user.website) && (
        <Card>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {user.twitter && (
              <a href={user.twitter} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded bg-sky-100 px-3 py-1.5 text-sm text-sky-700 hover:bg-sky-200 dark:bg-sky-900/50 dark:text-sky-400">
            ...
            {user.github && (
              <a href={user.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded bg-gray-100 px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300">
            ...
            {user.website && (
              <a href={user.website} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded bg-green-100 px-3 py-1.5 text-sm text-green-700 hover:bg-green-200 dark:bg-green-900/50 dark:text-green-400">
            ...
            {allocations.map((alloc) => (
              <div key={alloc.id} className="rounded border border-gray-200 p-3 dark:border-gray-700">
                ...
                <div className="mt-2 flex items-baseline justify-between">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">/ {alloc.allocated + alloc.adjusted} days</span>
                </div>
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Used: {alloc.used}</p>
              </div>
            ))}
          </div>
        )}
