...
export default function MobileAppPage() {
  ...
  const baseUrl =
    mobileConfig?.baseUrl || (typeof window !== "undefined" ? window.location.origin : "");
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Scan to setup mobile app</p>
      </div>
      ...
      <div className="max-w-sm mx-auto text-center">
        ...
        <div className="mt-4">
          {orgSettings?.logoUrl && (
            ...
            <img src={orgSettings.logoUrl} alt="" className="mx-auto h-8 w-8 object-contain" />
          )}
          <p className="mt-2 font-medium text-gray-900 dark:text-white">{orgSettings?.name}</p>
        </div>
